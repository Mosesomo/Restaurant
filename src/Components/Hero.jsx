...
const Hero = () => {
  return (
    <div className="w-[100%] bg-black p-7 lg:flex justify-between items-center">
      <div className="w-[100%]">
          ...
          <button className="bg-white text-center text-black font-[italic] p-1 rounded-md mt-5 hover:bg-yellow-300 hover:scale-105 ease-in-out duration-300">Explore Menu</button>
      </div>
      <div className="w-[100%]">
        <img className="object-cover w-[100%]" src={welcome} alt=""></img>
      </div>
    </div>
  )
}
