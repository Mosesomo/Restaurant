...
const About = () => {
  return (
    <div className="w-100%] h-full p-9 mt-10">
      <div className="w-[100%] relative">
        <div className="w-100% flex justify-center items-center">
          <img className="w-[400px] object-cover" src="https://github.com/adrianhajdin/project_modern_ui_ux_restaurant/blob/main/src/assets/G.png?raw=true" alt="" />
        </div>

        <div className="w-[100%] flex justify-center items-center absolute top-[-18%]">
          <div className="flex justify-center items-center gap-7  w-[100%] p-6">
            <div className="w-[100%]">
              ...
              <div className="flex justify-end items-end mt-6">
                <button className=" bg-white py-2 px-4 text-black font-semibold hover:bg-yellow-400">Know More</button>
              </div>
            </div>
            <div className="">
